...
def plot_metrics(metrics):
    ...
    plt.legend()
    plt.grid()
    plt.savefig('plots/Vanilla LGL training_loss_curves_da.png')  # Save the figure
    # plt.show()
    ...
    plt.legend()
    plt.grid()
    plt.savefig('plots/Vanilla LGL training_accuracy_curves_da.png')  # Save the figure
    # plt.show()
    ...
    plt.legend()
    plt.grid()
    plt.savefig('plots/Vanilla LGL test_accuracy_curves_da.png')  # Save the figure
    # plt.show()
...
def save_metrics_per_group(metrics, output_dir="data_pkl"):
    ...
    output_filename = f"metrics_vanilla_VGG13_da.pkl"
    output_path = os.path.join(output_dir, output_filename)
...
full_train_set = torchvision.datasets.ImageFolder(root='/home/csgrad/dl_228/LGL/Local-to-Global-Learning-for-DNNs/Datasets_batch/group_5/train', transform=train_transform)
test_set = torchvision.datasets.ImageFolder(root='/home/csgrad/dl_228/LGL/Local-to-Global-Learning-for-DNNs/Datasets_batch/group_5/val', transform=test_transform)
