...
def main():
    ...
    plt.suptitle('Training Loss and Accuracy (Vanilla VGG-13)')

    # Save the plot to a file
    plt.savefig('plots/vanilla_vgg13_SGD.png', dpi=300, bbox_inches='tight')
    ...
    with open("data_pkl/vgg13_vanilla_data.pkl", "wb") as f:
