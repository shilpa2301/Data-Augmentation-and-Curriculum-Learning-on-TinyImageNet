...
class AutoAugment(object):
    def __init__(self):
        ...
        self.policies = [
            ['Posterize', 0.4, 8, 'Rotate', 0.6, 9], #0
            ['Solarize', 0.6, 5, 'AutoContrast', 0.6, 5],#1
            ['Equalize', 0.8, 8, 'Equalize', 0.6, 3],#2
            ['Posterize', 0.6, 7, 'Posterize', 0.6, 6],#3
            ['Equalize', 0.4, 7, 'Solarize', 0.2, 4], #4
            ['Equalize', 0.4, 4, 'Rotate', 0.8, 8], #5
            ['Solarize', 0.6, 3, 'Equalize', 0.6, 7],#6
            ['Posterize', 0.8, 5, 'Equalize', 1.0, 2], #7
            ['Rotate', 0.2, 3, 'Solarize', 0.6, 8], #8
            ['Equalize', 0.6, 8, 'Posterize', 0.4, 6], #9
            ['Rotate', 0.8, 8, 'Color', 0.4, 0], #10
            ['Rotate', 0.4, 9, 'Equalize', 0.6, 2], #11
            ['Equalize', 0.0, 7, 'Equalize', 0.8, 8], #12
            ['Invert', 0.6, 4, 'Equalize', 1.0, 8], #13
            ['Color', 0.6, 4, 'Contrast', 1.0, 8], #14
            ['Rotate', 0.8, 8, 'Color', 1.0, 2], #15
            ['Color', 0.8, 8, 'Solarize', 0.8, 7], #16
            ['Sharpness', 0.4, 7, 'Invert', 0.6, 8], #17
            ['ShearX', 0.6, 5, 'Equalize', 1.0, 9], #18
            ['Color', 0.4, 0, 'Equalize', 0.6, 3], #19
            ['Equalize', 0.4, 7, 'Solarize', 0.2, 4], #20
            ['Solarize', 0.6, 5, 'AutoContrast', 0.6, 5], #21
            ['Invert', 0.6, 4, 'Equalize', 1.0, 8], #22
            ['Color', 0.6, 4, 'Contrast', 1.0, 8], #23
