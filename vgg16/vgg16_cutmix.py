...
def main():
    ...
    with open("data_pkl/vgg16_cutmix_0.2_data.pkl", "wb") as f:
    ...
    data_to_save = {
            ...
            # Save the dictionary to a pickle file
    with open("data_pkl/vgg16_cutmix_0.4_data.pkl", "wb") as f:
                pickle.dump(data_to_save, f)
    ...
    # Save the dictionary to a pickle file
    with open("data_pkl/vgg16_cutmix_0.6_data.pkl", "wb") as f:
            pickle.dump(data_to_save, f)
