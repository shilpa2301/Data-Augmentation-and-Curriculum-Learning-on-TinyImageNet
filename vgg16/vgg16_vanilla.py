...
def main():
    ...
    B = 128 #batch size
    lr = 0.01 #learning rate for weights=None VGG16
    ...
    plt.suptitle('Training Loss and Accuracy (Vanilla VGG-16)')

    # Save the plot to a file
    plt.savefig('plots/vanilla_vgg16_Adam.png', dpi=300, bbox_inches='tight')
    ...
    with open("data_pkl/vgg16_vanilla_data.pkl", "wb") as f:
